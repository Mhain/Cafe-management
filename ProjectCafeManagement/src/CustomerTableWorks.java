...
public class CustomerTableWorks extends JFrame{
    ...
    public CustomerTableWorks() {
        super("Customer Table List ");
        this.setLayout(null);
 ...
 if (name != null && gender != null && dob != null && password != null && password1 != null && address != null && contactNumber != null && email != null) {
            try {
                FileWriter fw1 = new FileWriter("customerdetails.txt", true);
                ...
                bw1.newLine();
                BufferedWriter bw2 = new BufferedWriter(new FileWriter("customerlogin.txt", true));
                bw1.write(name);
                bw1.write(";");
                bw1.write(password);
                bw1.newLine();
