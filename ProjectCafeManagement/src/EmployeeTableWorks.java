...
public class EmployeeTableWorks extends JFrame {
    ...
    public EmployeeTableWorks() {
        super("Employee Table List ");
        this.setLayout(null);
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (name != null && gender != null && dob != null && password != null && password1 != null && address != null && contactNumber != null && email != null) {
                    try {
                        ...
                        bw1.newLine();
                        BufferedWriter bw2 = new BufferedWriter(new FileWriter("employeelogin.txt", true));
                        bw1.write(name);
                        bw1.write(";");
                        bw1.write(password);
                        bw1.newLine();
    ...
    void addTable() {
        ...
        if (!jtf1.getText().trim().equals("")) {
            ...
            jtf4.setText("All the data must fe given");
